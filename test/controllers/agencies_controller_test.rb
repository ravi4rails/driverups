...
class AgenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agency" do
    assert_difference('Agency.count') do
      post agencies_url, params: { agency: { cover_image: @agency.cover_image, logo: @agency.logo, name: @agency.name } }
    end
  ...
  test "should update agency" do
    patch agency_url(@agency), params: { agency: { cover_image: @agency.cover_image, logo: @agency.logo, name: @agency.name } }
